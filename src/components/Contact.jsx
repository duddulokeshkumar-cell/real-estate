        ...
        overflow-hidden ' id='contact'>
            ...
            <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
                <div className='flex flex-wrap'>
                    ...
                    py-3 px-4 mt-2' type="text" name='Name' placeholder='Your Name'
                     required />
                    </div>
                    ...
                    <div className='w-full md:w-1/2 text-left md:pl-4'>
                        Your Email
                    <input className='w-full border border-gray-300 rounded
                    py-3 px-4 mt-2' type="email" name='Email' placeholder='Your Email'
                     required />
                    </div>
                </div>
                ...
                px-12 mb-10 rounded'>{result ? result : "Send Message"}</button>
            </form>
        </motion.div>   
    </>
  )
