...
const Head = () => {
  return (
    <div className='min-h-screen mb-4 bg-center bg-cover flex
    ...
    style={{backgroundImage:"url('/header_img.png')"}}>
        ...
        lg:px-32 text-white'>
            <h2 className='text-5xl sm:text-6xl inline-block max-w-3xl
            md:text-[82px] font-semibold pt-20'>Explore homes that fit your dreams</h2>
